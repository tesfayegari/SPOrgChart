...
function drawOrganizationChart(params) {
  ...
  function update(source, param) {
    ...
    function tooltipContent(item) {
      ...
      strVar += "    <!--";
      strVar +=
        '    <div class="tooltip-image-wrapper"> <img width="300" src="https:\/\/raw.githubusercontent.com\/bumbeishvili\/Assets\/master\/Projects\/D3\/Organization%20Chart\/cto.jpg"> <\/div>';
      strVar += "-->";
      strVar +=
      ...
      strVar +=
        "     <button class='" +
        (item.unit.type == "business" ? " disabled " : "") +
        " btn btn-tooltip-department' onclick='params.funcs.departmentClick(" +
